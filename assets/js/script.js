$(document).ready(function () {
  ...
  emailjs.init("RUtYJYLKQZ9a9cKaP");
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Karan Aswani";
...
var typed = new Typed(".typing-text", {
    strings: ["Software Development", "Data Analytics", "Artificial Intelligence", "Machine Learning"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
(function () {
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/687cc70c74f86d1919a5ff09/1j0jmj2q6';
    s1.charset = 'UTF-8';
